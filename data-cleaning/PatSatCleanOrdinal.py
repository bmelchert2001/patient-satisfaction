...
path = 'C:\\Users\melcb01\\.PyCharm2018.3\\patsat'
os.chdir(path)
...
# Standardize, normalize the features for spot-check algorithms
...
howcat = pd.cut(yH, bins, labels=group_names)
yH = enc.fit(howcat)
yH = enc.transform(howcat)
