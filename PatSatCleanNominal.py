...
#for col in Xnum_col:
#    scaler_X = scaler.fit(X_train[Xnum_col])
#    scaler_X.transform(X_train[Xnum_col])
#    scaler_X.transform(X_test[Xnum_col])

## Create training and test sets
#from sklearn.model_selection import train_test_split
#X_train, X_test, y_train, y_test = train_test_split(X, y, test_size = 0.3, random_state=42)

## Organize variables into Target and Feature columns;  Extract column names for reference
#X = df.iloc[:,3:]
#y = df.iloc[:,:3].values
#df14 = df.iloc[:,0]
#df05 = df.iloc[:,1]
...
#X_train, X_test, y_train, y_test = train_test_split(X, y, test_size = 0.3, random_state=42)
#
## Identify numerical columns of X to scale
#Xnum_col = ['p1400121', 'sdmPk', 'p1400120','p1400220', 'p1400320', 'p1400420', 
#            'p1400520', 'p1400620', 'p1400720','p1400820', 'p1400920', 'p1400403',
#            'p1400503', 'p1401020', 'p1401120','p1401220', 'p1401320', 'p1401420',
#            'p0200202', 'p0801402', 'p0302402','p0302902', 'p1102102', 'p0340602',
#            'p0349502', 'p0501102', 'p0500302','p0001100', 'p0001200', 'p1400102',
#            'p1500526', 'p0700102','p1400143', 'p1400243', 'p1400343', 'p0003100',
#            'p0300502', 'p1400202', 'p0610503','p0610603', 'p0610703', 'p0610803',
#            'p0610903', 'p1400203', 'p1400103','p1400303', 'Age1', 'Nursing',
#            'Doctor', 'Room', 'Staff','Black', 'Asian', 'Pacific', 'Indian',
#            'White', 'staffedbeds','admissions', 'census', 'outpatientvisits',
#            'births', 'totalexpense','payrollexpense', 'personnel', 'TotalperPersonnel',
#            'Payrollperpersonnel', 'BedperPersonnel', 'AdmperPersonnel']
#
## Scale X_train features, then apply to X_train and X_test
#from sklearn.preprocessing import MinMaxScaler
#scaler = MinMaxScaler()
#
#for col in Xnum_col:
...
#
## File save info
#df.to_pickle('all_3targets')
#
##print('VARIABLES STORED: X, y, dfy, X_train, X_test, y_train, y_test, col_names, X_names, y_names')
#
#
#
#
### REFERENCE CODE BELOW FOR FUTURE CLEANING EFFORTS
#
##for col in ['p0000600', 'p0001500', 'p0013900', 'p0011900', 'p0003000', 'p0033200']:
##    ps.drop([col], axis=1, inplace=True)
##    row_count = sum(ps.apply(lambda col: sum(col.isnull().values), axis = 1)>0)
##    print(ps.shape, row_count)
#
## Gather information about data
##pd.set_option('display.max_columns', 100)   
## pd.reset_option("^display") ## Resets display options
##ps.head()  
##ps.info()
##ps.shape
##ps.dtypes
